...
public class testStreamAll {
    ...
    public void testlimit_skip(){
        ...
        javaProgrammers.stream()
                .filter(genderFilter)
                .limit(3)
                .forEach((p) -> System.out.printf("%s %s %s; ", p.getId(), p.getFirstName(), p.getLastName()));

        System.out.println();
        System.out.println("取第3到第5个 Java programmers:");
        javaProgrammers.stream()
                .skip(2)
                .limit(3)
                .forEach((p) -> System.out.printf("%s %s %s; ", p.getId(), p.getFirstName(), p.getLastName()));
    ...
    public void testSort_max_min(){
        ...
        sortedJavaProgrammers.forEach((p) -> System.out.printf("%s %s; %n", p.getFirstName(), p.getSalary()));
    ...
    public void testParallel(){
        System.out.println("并行 计算付给 Java programmers 的所有money:");
